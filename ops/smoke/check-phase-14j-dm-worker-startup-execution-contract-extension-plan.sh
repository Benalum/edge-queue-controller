...
PHASE="phase-14j-dm-worker-startup-execution-contract-extension-plan"
DOC="docs/${PHASE}.md"
DB="edge_queue.sqlite3"
SERVICE="edge-queue-controller.service"

echo "=== Phase 14J-DM smoke: worker startup execution contract extension plan ==="

test -f "$DOC"
echo "PASS: DM doc exists"
...
for marker in \
  ...
  "NEXT_SAFE_PHASE=controller_power_start_worker_dry_run_requires_approval"; do
...
echo "PASS: production runtime remains unchanged after DM"
echo "PASS: Phase 14J-DM worker startup execution contract extension plan smoke passed"
