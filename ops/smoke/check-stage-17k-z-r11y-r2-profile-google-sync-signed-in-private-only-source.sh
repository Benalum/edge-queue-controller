...
DOC="docs/stage-17k-z-r11y-r2-profile-google-sync-signed-in-private-only-source.md"

test -f "$PANEL"
test -f "$DOC"

grep -Fq "PROFILE_GOOGLE_SYNC_SIGNED_IN_PRIVATE_PROFILE_ONLY_R11Y_R2" "$PANEL"
...
echo "PASS stage-17k-z-r11y-r2 Profile Google sync signed-in private-only source smoke"
