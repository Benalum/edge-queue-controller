...
grep -F "PHASE_14J_CK_GATE_B0_SYNTHETIC_WORKER_AVAILABILITY_SMOKE_ARTIFACT" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CK_GATE_B0_SYNTHETIC_WORKER_AVAILABILITY_SMOKE_ARTIFACT"
