...
grep -F "PHASE_14J_CQ_OLD_RESEND_SMTP_API_KEY_REVOCATION_CHECKPOINT" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CQ_OLD_RESEND_SMTP_API_KEY_REVOCATION_CHECKPOINT"
