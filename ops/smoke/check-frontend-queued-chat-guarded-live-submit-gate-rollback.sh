...
echo "=== frontend queued chat guarded live-submit gate rollback smoke ==="
...
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "static verification only" "static only"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "does not change frontend runtime behavior" "no runtime change"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "does not wire queued chat into the real submit handler" "no submit wiring"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "does not enable queued chat by default" "default disabled"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "Rollback must remain instant" "rollback requirement"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "guardedLiveSubmitGateWired false keeps guarded gate out of live submit" "gate rollback"
require_fixed docs/frontend-queued-chat-guarded-live-submit-gate-rollback.md "Stage 5F-66 should add a final live-submit wiring implementation plan" "next stage"
...
print("OK: guarded gate rollback markers remain near submit path")
PYCHECK
...
echo "PASS: frontend queued chat guarded live-submit gate rollback smoke passed"
