...
PHASE="phase-14j-db-bounded-service-flag-activation-with-disabled-offline-seeded-rows-plan"
DOC="docs/${PHASE}.md"
DB="edge_queue.sqlite3"
SERVICE="edge-queue-controller.service"

echo "=== Phase 14J-DB smoke: bounded service flag activation plan ==="

test -f "$DOC"
echo "PASS: DB phase doc exists"
...
for marker in \
  ...
  "NEXT_SAFE_PHASE=bounded_service_flag_activation_with_disabled_offline_seeded_rows_execution_requires_approval"; do
...
echo "PASS: production runtime remains default-off after DB plan"
echo "PASS: Phase 14J-DB bounded service flag activation plan smoke passed"
