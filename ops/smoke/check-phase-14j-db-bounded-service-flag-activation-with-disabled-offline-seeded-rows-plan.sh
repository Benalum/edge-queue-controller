...
MARKER="PHASE_14J_DB_BOUNDED_SERVICE_FLAG_ACTIVATION_WITH_DISABLED_OFFLINE_SEEDED_ROWS_PLAN"

echo "=== Historical post-DF compatibility smoke: ${PHASE} ==="

test -f "$DOC"
echo "PASS: historical doc exists: $DOC"

grep -F "$MARKER" "$DOC" >/dev/null
echo "PASS: historical phase marker found: $MARKER"
...
echo "PASS: historical pre-DF smoke is compatible with post-DF enabled-metadata/offline runtime state"
