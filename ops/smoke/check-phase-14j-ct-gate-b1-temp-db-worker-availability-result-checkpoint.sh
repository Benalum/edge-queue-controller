...
grep -F "PHASE_14J_CT_GATE_B1_TEMP_DB_WORKER_AVAILABILITY_RESULT_CHECKPOINT" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CT_GATE_B1_TEMP_DB_WORKER_AVAILABILITY_RESULT_CHECKPOINT"
