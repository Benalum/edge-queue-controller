...
echo "=== frontend queued chat live-submit wiring implementation plan static check ==="
...
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "planning and static verification only" "planning/static only"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "does not change frontend runtime behavior" "no runtime change"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "does not wire queued chat into the real submit handler" "no submit wiring"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "does not enable queued chat by default" "default disabled"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "AI_PLATFORM_QUEUED_CHAT_ENABLED is true" "flag requirement"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "guardedLiveSubmitGateWired is true" "gate wire requirement"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "guardedLiveSubmitWired is true" "live wire requirement"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "legacy submit path remains unchanged" "flag off legacy"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "flag-on but unwired behavior" "flag on unwired"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "evaluate guarded live-submit gate once" "gate once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "build safe payload once" "payload once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "make submit decision once" "decision once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "run queued submit orchestration once" "orchestration once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "render assistant placeholder once" "placeholder once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "poll status once per job_id" "poll once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "render final assistant reply once" "final once"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "duplicate POST /api/chat/queued calls" "duplicate POST protection"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "The frontend must not send:" "security behavior"
require_fixed docs/frontend-queued-chat-live-submit-wiring-implementation-plan.md "Stage 5F-67 should add a mocked live-submit wiring dry-run harness" "next stage"
...
print("OK: implementation-plan prerequisites remain unwired and near submit path")
PYCHECK
...
echo "PASS: frontend queued chat live-submit wiring implementation plan markers are present"
