...
grep -F "PHASE_14J_CM_SOURCE_PATCH_ACCEPTS_LANE_JOBS_AND_NO_LANE_FILTER_CONTRACT" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CM_SOURCE_PATCH_ACCEPTS_LANE_JOBS_AND_NO_LANE_FILTER_CONTRACT"
