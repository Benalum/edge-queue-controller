...
grep -F "PHASE_14J_CU_GATE_B2_PRODUCTION_WORKER_METADATA_SEED_PLAN" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CU_GATE_B2_PRODUCTION_WORKER_METADATA_SEED_PLAN"
