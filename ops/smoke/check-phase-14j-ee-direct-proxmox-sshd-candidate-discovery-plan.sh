...
PHASE="phase-14j-ee-direct-proxmox-sshd-candidate-discovery-plan"
DOC="docs/${PHASE}.md"
DB="edge_queue.sqlite3"
SERVICE="edge-queue-controller.service"

echo "=== Phase 14J-EE smoke: direct Proxmox sshd candidate discovery plan ==="

test -f "$DOC"
echo "PASS: EE doc exists"
...
for marker in \
  ...
  "NEXT_SAFE_PHASE=direct_proxmox_sshd_candidate_read_only_diagnostics_second_retry_requires_approval"; do
...
echo "PASS: production runtime remains unchanged after EE discovery plan"
echo "PASS: Phase 14J-EE direct Proxmox sshd candidate discovery plan smoke passed"
