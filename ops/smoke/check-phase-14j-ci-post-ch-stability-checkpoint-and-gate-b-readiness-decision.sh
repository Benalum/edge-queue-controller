...
PHASE="phase-14j-ci-post-ch-stability-checkpoint-and-gate-b-readiness-decision"
DOC="docs/${PHASE}.md"
DB="edge_queue.sqlite3"
SERVICE="edge-queue-controller.service"

echo "=== Phase 14J-CI smoke: post-CH stability checkpoint ==="

test -f "$DOC"
echo "PASS: CI doc exists"
...
for marker in \
  ...
  "SECURITY_FOLLOWUP_REQUIRED=rotate_exposed_smtp_credential"; do
...
echo "PASS: Phase 14J-CI post-CH stability checkpoint smoke passed"
