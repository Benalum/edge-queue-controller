...
grep -q '/privatepages/admin/admin-users.css?v=20260628-admin-users-r3u8' frontend/wrapper-ui/apc-wrapper-local/index.html
grep -q '/privatepages/admin/admin-users.js?v=20260628-admin-users-r3u8' frontend/wrapper-ui/apc-wrapper-local/index.html
...
grep -q '/privatepages/pages/admin.html?v=20260628-admin-users-r3u8' frontend/wrapper-ui/apc-wrapper-local/privatepages/privatepages.js
grep -q '/privatepages/privatepages.js?v=20260628-admin-users-r3u8' frontend/wrapper-ui/apc-wrapper-local/index.html
