...
grep -q '/privatepages/pages/admin.html?v=20260628-admin-users-r3u9' frontend/wrapper-ui/apc-wrapper-local/privatepages/privatepages.js
grep -q '/privatepages/privatepages.js?v=20260628-admin-users-r3u9' frontend/wrapper-ui/apc-wrapper-local/index.html
