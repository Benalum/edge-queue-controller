...
PHASE="phase-14j-dj-persistent-lane-worker-startup-contract-clarification"
DOC="docs/${PHASE}.md"
DB="edge_queue.sqlite3"
SERVICE="edge-queue-controller.service"

echo "=== Phase 14J-DJ smoke: persistent lane worker startup contract clarification ==="

test -f "$DOC"
echo "PASS: DJ doc exists"
...
for marker in \
  ...
  "NEXT_SAFE_PHASE=bounded_worker_liveness_startup_plan"; do
...
echo "PASS: production runtime remains unchanged after DJ"
echo "PASS: Phase 14J-DJ startup contract clarification smoke passed"
