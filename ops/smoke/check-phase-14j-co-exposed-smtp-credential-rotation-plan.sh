...
grep -F "PHASE_14J_CO_EXPOSED_SMTP_CREDENTIAL_ROTATION_PLAN" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CO_EXPOSED_SMTP_CREDENTIAL_ROTATION_PLAN"
