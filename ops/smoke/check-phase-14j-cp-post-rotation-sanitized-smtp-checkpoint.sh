...
grep -F "PHASE_14J_CP_POST_ROTATION_SANITIZED_SMTP_CHECKPOINT" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CP_POST_ROTATION_SANITIZED_SMTP_CHECKPOINT"
