...
grep -F "PHASE_14J_CS_GATE_B1_TEMP_DB_WORKER_AVAILABILITY_METADATA_SMOKE" "$DOC" >/dev/null
echo "PASS: historical phase marker found: PHASE_14J_CS_GATE_B1_TEMP_DB_WORKER_AVAILABILITY_METADATA_SMOKE"
