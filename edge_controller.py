...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8027-8036.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8098-8186.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8243-8273.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8276-8306.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8309-8327.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8837-8873.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8880-8941.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8944-8986.
# Private study/deck/card/session/progress data is browser-local only.




# Stage 17K-Z-R10G removed private study persistence route block originally at lines 8990-9013.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9016-9114.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9117-9165.
# Private study/deck/card/session/progress data is browser-local only.




# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9169-9188.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9191-9321.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9349-9359.
# Private study/deck/card/session/progress data is browser-local only.

# STAGE_5P11O_CUMULATIVE_STUDY_TOTALS_ENDPOINT_END


# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9363-9454.
# Private study/deck/card/session/progress data is browser-local only.
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9742-9757.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 9760-9775.
# Private study/deck/card/session/progress data is browser-local only.
...
# --- Phase 13P disabled voice settings contract helper ------------------

def _stage5p13p_disabled_voice_settings_contract(surface: str | None = None, user_id: str | None = None, profile: dict | None = None) -> dict:
    """Disabled, pure contract for future Study/Companion voice settings."""
    profile = profile or {}
    raw_surface = "study_companion_voice" if surface is None else str(surface).strip().lower()[:120]
    raw_user_id = "" if user_id is None else str(user_id)
    target_frontend_files = [
        "frontend/study-ui/app.js",
        "frontend/study-ui/index.html",
    ...
    return {
        "source": "phase_13p_disabled_voice_settings_contract_helper",
        "mode": "disabled_voice_settings_contract_only",
        "read_only": True,
        "network_calls": False,
        "runtime_action_available": False,
        "frontend_wired": False,
        ...
        "database_wired": False,
        "live_study_integration": False,
        "live_companion_integration": False,
        "execute_now": False,
        "would_call": "none",
        "model_call_allowed": False,
        "job_enqueue_allowed": False,
        ...
        "browser_speech_output_allowed": False,
        "tts_runtime_allowed": False,
        "stt_runtime_allowed": False,
        "database_write_allowed": False,
        "schema_migration_allowed": False,
        "storage_write_allowed": False,
        "file_upload_allowed": False,
        ...
        "frontend_mutation_allowed": False,
        "tool_call_allowed": False,
        "voice_settings_contract": {
            "surface": raw_surface,
            "user_id": raw_user_id,
            "target_frontend_files_when_enabled": target_frontend_files,
            "future_controls_when_enabled": future_controls,
            "preference_fields_when_enabled": preference_fields,
            ...
            "study_voice_controls_later": True,
            "companion_voice_controls_later": True,
            "immersive_study_voice_controls_later": True,
            "current_frontend_change_enabled": False,
            "current_static_asset_change_enabled": False,
        },
        "stt_contract": {
            ...
            "audio_upload_required_later": True,
            "streaming_stt_later": True,
            "language_from_profile_later": True,
            "fallback_to_typed_input": True,
        ...
        "tts_contract": {
            ...
            "speak_companion_replies_later": True,
            "speak_study_card_later": True,
            "speak_answer_explanation_later": True,
            "fallback_to_text_output": True,
            "current_tts_job_enabled": False,
            "current_audio_playback_enabled": False,
        },
        "api_dependency_contract": {
            "future_profile_preferences_endpoint": "/api/profile/preferences",
            "future_voice_settings_endpoint": "/api/profile/voice-settings",
            "future_stt_job_endpoint": "/api/jobs",
            "future_tts_job_endpoint": "/api/jobs",
            "future_required_job_types": ["stt", "tts"],
            "future_required_worker_capabilities": ["stt", "tts"],
            "current_backend_route_change_enabled": False,
        },
        "privacy_permission_contract": {
            ...
            "no_audio_storage_without_later_policy": True,
            "typed_input_must_remain_available": True,
            "voice_can_be_disabled_per_user": True,
            "voice_can_be_disabled_per_session": True,
        },
        "sample_settings_state": {
            "user_id": raw_user_id,
            "profile_context": {
                "preferred_language": profile.get("preferred_language"),
                "study_language": profile.get("study_language"),
                "voice_preference": profile.get("voice_preference"),
            },
            "voice_enabled": False,
            "listen_enabled": False,
            "speak_enabled": False,
        ...
        "activation_gates": {
            "requires_profile_preference_schema_design": True,
            "requires_live_profile_settings_ui_patch": True,
            "requires_live_study_ui_voice_patch": True,
            "requires_live_companion_ui_voice_patch": True,
            "requires_browser_permission_smoke": True,
            "requires_no_auto_microphone_capture_smoke": True,
            "requires_typed_input_regression_smoke": True,
            "requires_stt_worker_capability_smoke": True,
            "requires_tts_worker_capability_smoke": True,
            "requires_queue_job_contract_smoke": True,
            "requires_mobile_layout_smoke": True,
            "requires_no_login_redirect_regression": True,
            "requires_live_smoke_before_enable": True,
        },
        "safety": {
            ...
            "no_tts_runtime_change": True,
            "no_stt_runtime_change": True,
            "no_model_invocation": True,
            "no_queue_write": True,
            "no_worker_dispatch": True,
            "no_database_write": True,
...
# --- Phase 13Q disabled profile/study preferences contract helper --------

def _stage5p13q_disabled_profile_study_preferences_contract(user_id: str | None = None, profile: dict | None = None, surface: str | None = None) -> dict:
    """Disabled, pure contract for future profile-backed Study preferences."""
    profile = profile or {}
    raw_user_id = "" if user_id is None else str(user_id)
    raw_surface = "profile_study_preferences" if surface is None else str(surface).strip().lower()[:120]
    ...
    return {
        "source": "phase_13q_disabled_profile_study_preferences_contract_helper",
        "mode": "disabled_profile_study_preferences_contract_only",
        "read_only": True,
        "network_calls": False,
        "runtime_action_available": False,
        "frontend_wired": False,
        ...
        "execute_now": False,
        "would_call": "none",
        "profile_study_preferences_contract": {
            "surface": raw_surface,
            "user_id": raw_user_id,
            "future_preference_fields": preference_fields,
            "future_profile_preferences_endpoint": "/api/profile/preferences",
            "future_study_preferences_endpoint": "/api/profile/study-preferences",
            "future_companion_preferences_endpoint": "/api/profile/companion-preferences",
            "future_voice_settings_endpoint": "/api/profile/voice-settings",
            "profile_is_source_of_truth": True,
            "backend_api_is_authority": True,
            "frontend_reads_from_backend_only": True,
            "current_route_change_enabled": False,
            "current_frontend_change_enabled": False,
            "current_database_change_enabled": False,
        },
        "study_preference_defaults": {
            "preferred_language": profile.get("preferred_language") or "en",
            "study_language": profile.get("study_language") or profile.get("preferred_language") or "en",
            "learning_style": profile.get("learning_style") or "balanced",
            "study_explanation_depth": profile.get("study_explanation_depth") or "normal",
            "study_answer_strictness": profile.get("study_answer_strictness") or "balanced",
            "study_session_default_mode": profile.get("study_session_default_mode") or "standard_review",
            "allow_number_word_equivalence": True,
            "allow_minor_typo_tolerance": True,
            "typed_input_must_remain_available": True,
        },
        "companion_preference_defaults": {
            "companion_behavior": profile.get("companion_behavior") or "supportive_tutor",
            "companion_tone": profile.get("companion_tone") or "calm_clear",
            "companion_memory_scope": profile.get("companion_memory_scope") or "session_and_profile_approved",
        ...
        "calendar_preference_contract": {
            "calendar_provider_preference": profile.get("calendar_provider_preference") or "none",
            "allowed_future_calendar_providers": ["google_calendar", "apple_calendar"],
            "custom_local_calendar_database_allowed": False,
        ...
        "privacy_permission_contract": {
            ...
            "user_can_change_preferences_later": True,
            "user_can_disable_voice_later": True,
            "typed_input_must_remain_available": True,
            "preferences_must_not_expose_secrets": True,
        },
        "activation_gates": {
            "requires_profile_preference_schema_design": True,
            "requires_profile_preference_read_endpoint": True,
            "requires_profile_preference_write_endpoint": True,
        ...
        "sample_settings_state": {
            ...
            "companion_behavior": profile.get("companion_behavior"),
            "voice_preference": profile.get("voice_preference"),
            "calendar_provider_preference": profile.get("calendar_provider_preference"),
            "effective_voice_enabled": False,
            "effective_auto_listen_enabled": False,
            "effective_auto_speak_enabled": False,
        },
        "safety": {
...
# --- Phase 13R disabled profile preferences schema design helper --------

def _stage5p13r_disabled_profile_preferences_schema_design(user_id: str | None = None, existing_profile: dict | None = None) -> dict:
    """Disabled, pure schema-design contract for future profile preferences."""
    ...
    return {
        "source": "phase_13r_disabled_profile_preferences_schema_design_helper",
        "mode": "disabled_profile_preferences_schema_design_only",
        "read_only": True,
        ...
        "schema_contract": {
            "user_id": raw_user_id,
            "future_table_name": "app_user_preferences",
            "future_owner_table": "app_users",
            "future_primary_key": "user_id",
            "future_preference_fields": preference_fields,
            "profile_is_source_of_truth": True,
            "backend_api_is_authority": True,
            "frontend_reads_from_backend_only": True,
            "separate_preferences_table_recommended": True,
            "avoid_expanding_app_users_for_every_preference": True,
            "current_table_creation_enabled": False,
            "current_table_migration_enabled": False,
            "current_column_migration_enabled": False,
            "current_route_change_enabled": False,
            "current_frontend_change_enabled": False,
        },
        "field_type_contract": {
        ...
        "default_value_contract": {
            "preferred_language": existing_profile.get("preferred_language") or "en",
            "study_language": existing_profile.get("study_language") or existing_profile.get("preferred_language") or "en",
            "learning_style": existing_profile.get("learning_style") or "balanced",
            "study_explanation_depth": existing_profile.get("study_explanation_depth") or "normal",
            "study_answer_strictness": existing_profile.get("study_answer_strictness") or "balanced",
            "study_session_default_mode": existing_profile.get("study_session_default_mode") or "standard_review",
            "companion_behavior": existing_profile.get("companion_behavior") or "supportive_tutor",
            "companion_tone": existing_profile.get("companion_tone") or "calm_clear",
            "companion_memory_scope": existing_profile.get("companion_memory_scope") or "session_and_profile_approved",
            "voice_enabled": False,
            "listen_enabled": False,
            "speak_enabled": False,
            "auto_listen_enabled": False,
            "auto_speak_enabled": False,
            "calendar_provider_preference": existing_profile.get("calendar_provider_preference") or "none",
            "notification_preference": existing_profile.get("notification_preference") or "none",
            "accessibility_large_text": False,
            "accessibility_reduce_motion": False,
        },
        "validation_contract": {
            "allowed_learning_styles": ["balanced", "visual", "step_by_step", "concise", "detailed"],
            "allowed_study_explanation_depths": ["brief", "normal", "deep"],
            "allowed_study_answer_strictness": ["lenient", "balanced", "strict"],
            "allowed_study_session_default_modes": ["standard_review", "immersive_review"],
            "allowed_companion_behaviors": ["supportive_tutor", "direct_helper", "study_coach"],
            "allowed_companion_tones": ["calm_clear", "encouraging", "concise"],
            "allowed_companion_memory_scopes": ["session_only", "session_and_profile_approved"],
            "allowed_calendar_provider_preferences": ["none", "google_calendar", "apple_calendar"],
            "custom_local_calendar_database_allowed": False,
            "calendar_event_storage_allowed_in_controller": False,
            "typed_input_must_remain_available": True,
            "number_word_equivalence_must_remain_available": True,
        },
        "future_endpoint_contract": {
            "read_endpoint": "/api/profile/preferences",
            "write_endpoint": "/api/profile/preferences",
            "study_endpoint": "/api/profile/study-preferences",
            "companion_endpoint": "/api/profile/companion-preferences",
            "voice_endpoint": "/api/profile/voice-settings",
            "current_routes_enabled": False,
            "future_writes_require_authenticated_user": True,
            "future_writes_require_field_allowlist": True,
            "future_writes_must_not_accept_unknown_fields": True,
        },
        "privacy_permission_contract": {
            "no_profile_write_in_this_phase": True,
            "no_background_personalization_changes": True,
        ...
        "activation_gates": {
            "requires_schema_migration_plan": True,
...
# --- Phase 13S disabled profile preferences read endpoint contract helper --------

def _stage5p13s_disabled_profile_preferences_read_endpoint_contract(user_id: str | None = None, existing_profile: dict | None = None) -> dict:
    """Disabled, pure read-endpoint contract for future profile preferences."""
    existing_profile = existing_profile or {}
    raw_user_id = "" if user_id is None else str(user_id)
    ...
    safe_defaults = {
        ...
        "auto_listen_enabled": False,
        "auto_speak_enabled": False,
        "timezone": existing_profile.get("timezone") or "profile_default",
        "locale": existing_profile.get("locale") or "en-US",
        "calendar_provider_preference": existing_profile.get("calendar_provider_preference") or "none",
        "notification_preference": existing_profile.get("notification_preference") or "none",
        "accessibility_large_text": False,
        "accessibility_reduce_motion": False,
    ...
    return {
        "source": "phase_13s_disabled_profile_preferences_read_endpoint_contract_helper",
        "mode": "disabled_profile_preferences_read_endpoint_contract_only",
        "read_only": True,
        "endpoint_contract_only": True,
        "runtime_action_available": False,
        "route_wired": False,
        "frontend_wired": False,
        "database_wired": False,
        ...
        "future_response_contract": {
            "status": "disabled_contract_only",
            "preferences": safe_defaults,
            "available_fields": preference_fields,
        ...
        "privacy_permission_contract": {
            ...
            "no_sensitive_attribute_inference": True,
            "preferences_must_not_expose_secrets": True,
            "read_endpoint_must_not_create_or_update_rows": True,
            "read_endpoint_must_not_trigger_model_call": True,
            "read_endpoint_must_not_enqueue_job": True,
            "read_endpoint_must_not_dispatch_worker": True,
        },
        "activation_gates": {
            "requires_profile_preference_schema_migration": True,
            "requires_profile_preference_read_route": True,
            "requires_authenticated_user_boundary_smoke": True,
            "requires_safe_default_response_smoke": True,
            "requires_no_write_on_read_smoke": True,
            "requires_no_unknown_field_response_smoke": True,
...
# --- Phase 13W disabled profile preferences schema migration readiness helper -

def _stage5p13w_profile_preferences_schema_migration_readiness(user_id: str | None = None) -> dict:
    """Disabled, pure readiness contract for future app_user_preferences schema migration."""
    raw_user_id = "" if user_id is None else str(user_id)
    ...
    return {
        "source": "phase_13w_profile_preferences_schema_migration_readiness_helper",
        "mode": "disabled_profile_preferences_schema_migration_readiness_only",
        "read_only": True,
        "inspection_only": True,
        "schema_migration_readiness_only": True,
        "runtime_action_available": False,
        "route_wired": False,
        "frontend_wired": False,
        "database_wired": False,
        ...
        "would_call": "none",
        "user_id": raw_user_id,
        "observed_runtime_readiness": {
            "database_engine": "sqlite3",
            "database_path_constant": "DB_PATH",
            "observed_database_file": "edge_queue.sqlite3",
            "account_table": "app_users",
            "auth_session_table": "user_sessions",
            "account_init_function": "_account_init_tables",
            "column_add_helper": "_account_add_column_if_missing",
            "auth_user_helper": "_auth_current_user_from_request",
            "profile_stack_rollup_phase": "phase-13v-disabled-profile-preferences-contract-rollup",
            "profile_stack_rollup_tag": "controller-phase-13v-disabled-profile-preferences-contract-rollup-2026-06-14",
            "quiet_stack_runner": "ops/smoke/run-stack-quiet.sh profile",
        },
        "future_schema_contract": {
            "table_name": "app_user_preferences",
            "owner_table": "app_users",
            "primary_key": "user_id",
            "foreign_key": "user_id references app_users.id",
            ...
            "must_not_store_auth_fields": True,
            "must_not_store_credit_fields": True,
            "must_not_store_provider_tokens": True,
            "must_not_store_calendar_events": True,
            "must_not_store_audio_blobs": True,
            "must_not_store_model_outputs": True,
            "must_not_store_sensitive_attribute_inferences": True,
        },
        "migration_safety_plan": {
            ...
            "future_migration_must_be_idempotent": True,
            "future_migration_must_preserve_existing_app_users": True,
            "future_migration_must_not_backfill_sensitive_attributes": True,
            "future_migration_must_not_create_preference_rows_for_existing_users": True,
            "future_migration_must_not_modify_auth_or_credit_columns": True,
            "future_migration_must_not_register_routes": True,
            "future_migration_must_not_modify_frontend": True,
            "future_migration_must_not_call_models": True,
            "future_migration_must_not_enqueue_jobs": True,
            "future_migration_must_not_dispatch_workers": True,
            "future_migration_must_not_store_calendar_events": True,
            "future_migration_must_not_create_custom_local_calendar_database": True,
        },
        "future_schema_smoke_gates": {
            "verify_migration_creates_app_user_preferences": True,
            "verify_required_columns_exist": True,
            "verify_primary_key_user_id": True,
            "verify_foreign_key_to_app_users": True,
            "verify_boolean_columns_are_integer_backed": True,
            "verify_calendar_provider_column_is_preference_only": True,
            "verify_no_calendar_event_storage_columns": True,
            "verify_no_auth_token_columns": True,
            "verify_no_credit_columns": True,
            "verify_no_audio_blob_columns": True,
            "verify_migration_idempotent_on_second_run": True,
            "verify_app_users_row_count_unchanged": True,
            "verify_no_preference_rows_created_by_migration": True,
            "verify_health_200_after_migration": True,
            "verify_profile_contract_stack_after_migration": True,
        },
        "future_activation_sequence": [
            "phase-13w-disabled-profile-preferences-schema-migration-readiness",
            "future-live-app-user-preferences-schema-migration",
            "future-live-profile-preferences-read-endpoint",
            "future-live-profile-preferences-write-endpoint",
            "future-live-profile-settings-ui",
            "future-study-companion-preference-consumption",
        ],
        "calendar_boundary": {
            "allowed_provider_preferences": ["none", "google_calendar", "apple_calendar"],
            "custom_local_calendar_database_allowed": False,
            "controller_calendar_event_storage_allowed": False,
            "calendar_provider_preference_only": True,
            "calendar_writes_require_explicit_user_request": True,
...
# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24267-24324.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24327-24329.
# Private study/deck/card/session/progress data is browser-local only.




# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24333-24388.
# Private study/deck/card/session/progress data is browser-local only.




# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24392-24485.
# Private study/deck/card/session/progress data is browser-local only.


# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24487-24591.
# Private study/deck/card/session/progress data is browser-local only.


# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24593-24970.
# Private study/deck/card/session/progress data is browser-local only.


# Stage 17K-Z-R10G removed private study persistence route block originally at lines 24972-25153.
# Private study/deck/card/session/progress data is browser-local only.



# Stage 17K-Z-R10G removed private study persistence route block originally at lines 25156-25432.
# Private study/deck/card/session/progress data is browser-local only.
