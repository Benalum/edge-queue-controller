# Stage 16 FC-O45-E-BE — Deploy Companion Hard-Clean Workspace over Tailscale Restricted Path

Date: 2026-06-24

Repo checkpoint before this phase:

- Expected HEAD/origin/main: `028df3d`
- Prior source tag: `controller-stage-16-fc-o45-e-bd-companion-hard-clean-visible-workspace-source-2026-06-24`
- Prior restricted deploy tag: `controller-stage-16-fc-o45-e-bc-deploy-companion-clean-chat-workspace-over-tailscale-restricted-path-2026-06-24`
...
```
APPROVE_FC_O45_E_BE_DEPLOY_COMPANION_HARD_CLEAN_WORKSPACE_OVER_TAILSCALE_RESTRICTED_PATH
```

## Deploy path

BE used the intended Tailscale/OpenSSH restricted deploy path:

```
cat package.tgz | ssh apcdeploy@website-edge 'deploy sha256=<sha256> bust=20260624fc045ebe'
```
...
- Public app.js contains Companion result-reader, Immersion, AZ primary-workspace, BB clean-chat, and BD hard-clean markers.
- Public app.js contains `Chat with your Companion`.
- Public app.js contains `installEnterToSend`.
- Public app.js contains `hideSmallestPanels`.
- Public app.js contains `companion-hard-clean-hidden`.
...
```
/app.js?v=20260624fc045ebe
```

## Expected user-visible change

The Companion page should now show only the clean primary chat flow:
...
The old panels should be hidden from the primary flow:
...
```
=== Stage 16 FC-O45-E-BE deploy Companion hard-clean workspace over Tailscale restricted path ===
APPROVAL=APPROVE_FC_O45_E_BE_DEPLOY_COMPANION_HARD_CLEAN_WORKSPACE_OVER_TAILSCALE_RESTRICTED_PATH
...
expected_head=028df3d
head_now=028df3d
origin_main_now=028df3d
git_preflight=PASS
...
local_pkg_sha256=23b921f7ba9cf5b1c3a79ec52ec6ffbb6bc4fd12a8b920b6273f99e2c4cdd9db
pkg_entry app.js
...
pvew
2026-06-25T01:06:28Z
pvew_pkg_sha256=23b921f7ba9cf5b1c3a79ec52ec6ffbb6bc4fd12a8b920b6273f99e2c4cdd9db
...
received_pkg_sha256=23b921f7ba9cf5b1c3a79ec52ec6ffbb6bc4fd12a8b920b6273f99e2c4cdd9db
backup_sha256 7776af5fb0b3c88d62558410595cc654cf7bc21c785b03109892658f5abf282f  /var/www/apc-wrapper-local/apc-vm200-static-deploy-backup-20260625T010628Z/app.js
backup_sha256 21f7b37fe14e6b6bb48d7121ac570eb278e7aa9c719ca9e13518e4745ec7ba55  /var/www/apc-wrapper-local/apc-vm200-static-deploy-backup-20260625T010628Z/styles.css
backup_sha256 0036c5edaf1197c0541c73ea73d0a7269c727e598f0d1dab97b663e64d209940  /var/www/apc-wrapper-local/apc-vm200-static-deploy-backup-20260625T010628Z/index.html
backup_dir=/var/www/apc-wrapper-local/apc-vm200-static-deploy-backup-20260625T010628Z
live_sha256 14cc2cb3d57de4c7babfce9e383df81487ff8d1bb4102bd4f75c95f9857b7106  /var/www/apc-wrapper-local/app.js
live_sha256 300b0ac6230d5b64d92ef0d416cd606b52289e313d5b9405dec69fa7d38f4d9e  /var/www/apc-wrapper-local/styles.css
live_sha256 d7b83bee2a58050ce7f9bbd8e7f18264a59e52437ecdf40c0ff695a20da34a4f  /var/www/apc-wrapper-local/index.html
APC_VM200_STATIC_DEPLOY_WRAPPER_UI_PASS cache_bust=20260624fc045ebe
restricted_tailscale_deploy=PASS
FC_O45_E_BE_RESTRICTED_DEPLOY_RECORDED
...
FC_O45_E_BE_DEPLOY_RECORDED new_app_js_bust=20260624fc045ebe
```
