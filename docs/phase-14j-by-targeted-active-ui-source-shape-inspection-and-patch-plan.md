# Phase 14J-BY - Targeted Active UI Source-Shape Inspection and Patch Plan
...
This phase performs a targeted active source-shape inspection before editing visible UI/source files.
...
1. `docs/phase-14j-by-targeted-active-ui-source-shape-inspection-and-patch-plan.md`
2. `docs/phase-14j-by-controller-owned-static-ui-copy-layout-patch-plan.md`
3. `ops/smoke/check-phase-14j-by-controller-owned-static-ui-copy-layout-patch-plan.sh`
...
Phase 14J-BZ should apply exact-string static UI copy/layout patches to the safest confirmed target files and run the ultra-concise v2 baseline.
